...
"""
Prime ideals of the ring R of integers of Q(sqrt(5)).
...
enumeration.  The main entry function is primes_of_bounded_norm::
    ...
    sage: v = sage.modular.hilbert.sqrt5_prime.primes_of_bounded_norm(50); v
...
the second split prime.::
    ...
    sage: type(v[8])
    <type 'sage.modular.hilbert.sqrt5_prime.Prime'>
    sage: v[8].sage_ideal()
...
cdef class Prime:
    ...
    def __init__(self, p, long r=0, bint first=True):
        ...
        and first or not with that characteristic.
        ...
        EXAMPLES::
            ...
            sage: from sage.modular.hilbert.sqrt5_prime import Prime
        ...
        Test that conversion both ways works for primes up to norm `10^5`::
            ...
            sage: from sage.modular.hilbert.sqrt5_prime import primes_of_bounded_norm, Prime
    ...
    def __hash__(self):
        """
        Return hash of this prime ideal.

        EXAMPLES::

            sage: from sage.modular.hilbert.sqrt5_prime import Prime
            sage: Prime(11,4,False).__hash__()
            55
        """
    ...
    def __cmp__(self, Prime right):
        ...
        EXAMPLES::
            ...
            sage: from sage.modular.hilbert.sqrt5_prime import primes_of_bounded_norm
...
def primes_above(long p, bint check=True):
    ...
    EXAMPLES::
        ...
        sage: from sage.modular.hilbert.sqrt5_prime import primes_above
        sage: primes_above(2)
        [2]
        sage: primes_above(3)
        [3]
...
def prime_range(long start, stop=None):
    ...
    *not* usual Sage prime ideals -- use the sage_ideal() method to
    ...
    EXAMPLES::
        ...
        sage: sage.modular.hilbert.sqrt5_prime.prime_range(10, 60)
        [11a, 11b, 19a, 19b, 29a, 29b, 31a, 31b, 41a, 41b, 7, 59a, 59b]
        sage: sage.modular.hilbert.sqrt5_prime.prime_range(2, 11)
        [2, 5a, 3]
        sage: sage.modular.hilbert.sqrt5_prime.prime_range(2, 12)
        [2, 5a, 3, 11a, 11b]
        sage: sage.modular.hilbert.sqrt5_prime.prime_range(3, 12)
        [2, 5a, 3, 11a, 11b]
        sage: sage.modular.hilbert.sqrt5_prime.prime_range(9, 12)
        [3, 11a, 11b]
        sage: sage.modular.hilbert.sqrt5_prime.prime_range(5, 12)
        [5a, 3, 11a, 11b]
    """
